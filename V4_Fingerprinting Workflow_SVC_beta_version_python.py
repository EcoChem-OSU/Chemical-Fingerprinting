def fingerprintingWorkflow(IDLabel: list, algorithm: str, verbose: bool = True, parameters = None, algorithmParameters = None, sourceDirectory = None):
    ...
    from V4_Fingerprinting_functions import selectFolder
    from V4_Fingerprinting_functions import testFingerprintFilePaths
    from V4_Fingerprinting_functions import generateTestingParameters
    from V4_Fingerprinting_functions import generateSVCParameters
    from V4_Fingerprinting_functions import importFingerprintData
    ...
    from V4_Fingerprinting_functions import test_metric
    from V4_Fingerprinting_functions import model_printout
    from V4_Fingerprinting_functions import model_execute
    ...
    from V4_Fingerprinting_functions import Norm_Importance
    from V4_Fingerprinting_functions import importance
    from V4_Fingerprinting_functions import saving_plotting_imp
    from V4_Fingerprinting_functions import retuning
    from V4_Fingerprinting_functions import retuning2
    from V4_Fingerprinting_functions import diagnostic_rerun
    from V4_Fingerprinting_functions import final_plots
    from V4_Fingerprinting_functions import fingerprintParametersClass
    from V4_Fingerprinting_functions import storingParametersClass
    from V4_Fingerprinting_functions import modeledResultsClass
    from V4_Fingerprinting_functions import importanceMetricsClass
    from V4_Fingerprinting_functions import createFolderPath
